...
import { createMatcherFromFind, memoizeRouteRulesMatcher } from "./_libs/h3-rules.mjs";
//#region #nitro/virtual/routing
const findRouteRules = (m, p) => {
	return [];
};
const _lazy_1MgAgi = defineLazyEventHandler(() => import("./_chunks/renderer-template.mjs"));
const findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_1MgAgi
	};
	return ((_m, p) => {
		return {
			data,
