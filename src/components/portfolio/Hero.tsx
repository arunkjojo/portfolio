...
function Typewriter({ text }: { text: string }) {
  ...
  return (
    <span className="relative">
      {displayedText}
      <span className="animate-blink border-r-2 border-[var(--lagoon-deep)] ml-0.5" />
    </span>
  )
}
  ...
  return (
    <section className="island-shell rise-in relative overflow-hidden rounded-[2.5rem] p-8 md:p-14 mb-12">
      ...
      <div className="relative z-10">
        ...
        {/* Portrait Image (positioned between subtitle and bio description) */}
        <div className="my-8 flex justify-start">
          <div className="relative group p-1.5 rounded-full border border-[var(--line)] bg-[var(--surface)] shadow-[0_15px_35px_rgba(30,90,72,0.12)] backdrop-blur-md transition-transform duration-300 hover:scale-[1.02]">
            <img
